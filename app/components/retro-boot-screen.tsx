...
export default function RetroBootScreen() {
  ...
  return (
    <div className="h-screen w-screen bg-[#000] flex flex-col items-center justify-center text-[#87CEFA] font-mono">
      <div className="text-6xl font-pixel font-bold mb-8 text-[#D8BFD8]">Portfolio MEM</div>
      <div className="w-96 h-10 bg-[#2a0044] border-2 border-[#8A2BE2] mb-4">
      ...
      <div className="h-6 font-orange text-xl mb-4">{loadingText}</div>
      <div className="text-lg font-pixel text-[#D8BFD8]">Chargement... {loadingPercentage}%</div>
    </div>
  )
}
